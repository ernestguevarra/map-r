...
```{r map1, echo = FALSE, eval = TRUE, fig.cap = "Map of the states of Sudan with default plotting options", fig.align = "center", fig.pos = "H", fig.width = 10, fig.height = 10, fig.retina = 1}
plot(sudan01)
```
...
```{r map2, echo = FALSE, eval = TRUE, fig.cap = "Map of the states of Sudan with new plotting parameters", fig.align = "center", fig.pos = "H", fig.width = 10, fig.height = 10, fig.retina = 1}
plot(sudan01, lty = 1, lwd = 2, border = "blue", col = "gray90")
```
...
```{r map3, echo = FALSE, eval = TRUE, fig.cap = "Map of localities and states of Sudan", fig.align = "center", fig.pos = "H", fig.width = 10, fig.height = 10, fig.retina = 1}
plot(sudan02, border = "gray")
plot(sudan01, lwd = 2, add = TRUE)
```
...
```{r map4, echo = FALSE, eval = TRUE, fig.cap = "Map of localities and states of Sudan with rectangular grid", fig.align = "center", fig.pos = "H", fig.width = 10, fig.height = 10, fig.retina = 1}
plot(sudan02, border = "gray")
plot(sudan01, lwd = 2, add = TRUE)
plot(grid12kmSudan, lwd = 0.5, col = "gray90", add = TRUE)
```
...
```{r map5, echo = FALSE, eval = TRUE, fig.cap = "Map of localities and states of Sudan with rectangular grid and villages", fig.align = "center", fig.pos = "H", fig.width = 10, fig.height = 10, fig.retina = 1}
plot(sudan02, border = "gray")
plot(sudan01, lwd = 2, add = TRUE)
plot(grid12kmSudan, lwd = 0.5, col = "gray90", add = TRUE)
points(villages$X, villages$Y, pch = 20, cex = 0.2, col = "gray90")
...
```{r map6, echo = FALSE, eval = TRUE, fig.cap = "Map of states of Sudan with labels", fig.align = "center", fig.pos = "H", fig.width = 10, fig.height = 10, fig.retina = 1}
sudan01Centroids <- coordinates(sudan01)
plot(sudan01)
text(x = sudan01Centroids[ , 1], 
     y = sudan01Centroids[ , 2], 
...
```{r map7, echo = FALSE, eval = TRUE, fig.cap = "Map of localities, states and villages of Sudan with labels and legend", fig.align = "center", fig.pos = "H", fig.width = 10, fig.height = 10, fig.retina = 1}
plot(sudan02, border = "gray")
plot(sudan01, lwd = 2, add = TRUE)
points(villages$X, 
       villages$Y, 
...
```{r map8, echo = FALSE, eval = TRUE, fig.cap = "Map of localities, states and villages of Sudan with labels, legend and scale", fig.align = "center", fig.pos = "H", fig.width = 10, fig.height = 10, fig.retina = 1}
plot(sudan02, border = "gray")
plot(sudan01, lwd = 2, add = TRUE)
points(villages$X, villages$Y, pch = 20, cex = 0.2, col = "gray90")
legend("topleft",
